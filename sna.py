...
def get_args():
    ...
    parser.add_argument("-at", "--article_text", dest="article", help="Specify text file to create network graph from")
    parser.add_argument("-lf", "--load_file", dest="loadFile", help="Specify previously generated json file to generate network graph from")
...
if __name__ == "__main__":
    ...
    # args = get_args()
    # articleText = args.article
    # jsonLoadFile = args.loadFile
    
    # if articleText and not jsonLoadFile:
    #     G, data = create_knowledge_graph(article_text=article)
    # elif jsonLoadFile and not articleText:
    #     G, data = create_knowledge_graph(load_file="network_dict.json")
    # else:
    #     print(f"Args provided: {args}\nMake sure you provide either a text file with --article_text, or a json file generated by the script earlier with --load_file")
    #     exit(0)
